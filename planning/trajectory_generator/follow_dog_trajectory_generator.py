...
class FollowDogTrajectoryGenerator:
    ...
    def __init__(self):
        ...
        self._num_horizon = 60
        self._human_horizon = 10
        self._local_path_timestep = 0.1
        self._local_trajectory = None
        self._proj_dist_buffer = 0.0
    ...
    def generate_trajectory_internal(self, pos, global_path):
        ...
        self._local_trajectory = np.hstack([path, path_head])
        self._human_trajectory = self._local_trajectory[-self._human_horizon:]
        # print("self._local_trajectory",self._local_trajectory)
        # print("self._human_trajectory",self._human_trajectory)
        return self._human_trajectory
