from control.follow_dcbf_optimizer import NmpcDbcfOptimizer, NmpcDcbfOptimizerParam
...
class NmpcDcbfController:
    ...
    def generate_control_input(self, system, human_trajectory, obstacles):
        self._optimizer.setup(self._param, system, human_trajectory, obstacles)
